...
public class StudentController {
    ...
    @GetMapping("/findStudent/{id}") // You have to give the id in {id} field.
    public ResponseEntity<StudentDto> findStudentById(@PathVariable Long id){ // @PathVariable is used to accept or retrieve the given 'id' value in URL.
